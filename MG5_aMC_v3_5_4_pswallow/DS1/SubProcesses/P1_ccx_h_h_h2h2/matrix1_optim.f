...
C     
C     Process: c c~ > h WEIGHTED<=1 @1
C     *   Decay: h > h2 h2 WEIGHTED<=1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $    ABS(mdl_MHS*small_width_treatment)), mdl_WHS)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MC,+1,+1*IC(1),W(1,1))  !  count 1
      CALL IXXXXX(P(0,1),MDL_MC,-1,+1*IC(1),W(1,2))  !  count 1
      CALL OXXXXX(P(0,2),MDL_MC,+1,-1*IC(2),W(1,3))  !  count 1
      CALL OXXXXX(P(0,2),MDL_MC,-1,-1*IC(2),W(1,4))  !  count 1
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,5))  !  count 1
      CALL SXXXXX(P(0,4),+1*IC(4),W(1,6))  !  count 1
      CALL SSS1_1(W(1,5),W(1,6),GC_67,MDL_MH,FK_MDL_WH,W(1,7))  !  count 2
      CALL FFS1_0(W(1,1),W(1,3),W(1,7),GC_71,AMP(1,1))
      CALL FFS1_0(W(1,2),W(1,4),W(1,7),GC_71,AMP(2,1))  !  count 1
