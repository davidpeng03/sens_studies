...
C     ----------
     ...
     $    ABS(MDL_MN1*SMALL_WIDTH_TREATMENT)), MDL_WN1)
      ...
      CALL IXXXXX(P(0,1),MDL_MN1,NHEL(1),+1*IC(1),W(1,1))
...
C     Amplitude(s) for diagram number 1
      CALL FFS4_0(W(1,1),W(1,4),W(1,5),GC_52,AMP(1))
      CALL FFV5_6_3(W(1,3),W(1,2),GC_44,GC_40,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV5_0(W(1,1),W(1,4),W(1,5),GC_50,AMP(2))
      CALL FFV5_3(W(1,3),W(1,4),GC_22,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV5_0(W(1,1),W(1,2),W(1,5),GC_49,AMP(3))
