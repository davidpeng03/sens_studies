...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      CALL IXXXXX(P(0,1),MDL_MS,-1,+1*IC(1),W(1,2))  !  count 5
      CALL OXXXXX(P(0,2),MDL_MU,+1,-1*IC(2),W(1,3))  !  count 5
      CALL OXXXXX(P(0,2),MDL_MU,-1,-1*IC(2),W(1,4))  !  count 2
      CALL OXXXXX(P(0,3),MDL_ME,+1,+1*IC(3),W(1,5))  !  count 1
      CALL OXXXXX(P(0,3),MDL_ME,-1,+1*IC(3),W(1,6))  !  count 2
      CALL IXXXXX(P(0,4),MDL_MN1,+1,-1*IC(4),W(1,7))  !  count 2
      CALL IXXXXX(P(0,4),MDL_MN1,-1,-1*IC(4),W(1,8))  !  count 1
      CALL FFV5_3(W(1,7),W(1,5),GC_49,MDL_MW,FK_MDL_WW,W(1,9))  !  count 1
      CALL FFV5_3(W(1,7),W(1,6),GC_49,MDL_MW,FK_MDL_WW,W(1,10))  !  count 3
      CALL FFV5_3(W(1,8),W(1,6),GC_49,MDL_MW,FK_MDL_WW,W(1,11))  !  count 3
      CALL FFV5P1N_3(W(1,1), W(1,3), GC_24, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV5P1N_3(W(1,2), W(1,3), GC_24, TMP(1))
      call CombineAmp(3,
     & (/7,6,5/), 
     & (/9,10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV5P1N_3(W(1,2), W(1,4), GC_24, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/10,11/),
