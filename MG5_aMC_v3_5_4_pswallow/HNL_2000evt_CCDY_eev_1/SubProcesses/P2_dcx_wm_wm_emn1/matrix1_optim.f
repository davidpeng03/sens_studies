...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MD,+1,+1*IC(1),W(1,1))  !  count 1
      CALL IXXXXX(P(0,1),MDL_MD,-1,+1*IC(1),W(1,2))  !  count 4
      CALL OXXXXX(P(0,2),MDL_MC,+1,-1*IC(2),W(1,3))  !  count 3
      CALL OXXXXX(P(0,2),MDL_MC,-1,-1*IC(2),W(1,4))  !  count 2
      CALL OXXXXX(P(0,3),MDL_ME,-1,+1*IC(3),W(1,5))  !  count 2
      CALL IXXXXX(P(0,4),MDL_MN1,+1,-1*IC(4),W(1,6))  !  count 1
      CALL IXXXXX(P(0,4),MDL_MN1,-1,-1*IC(4),W(1,7))  !  count 1
      CALL FFV5_3(W(1,6),W(1,5),GC_49,MDL_MW,FK_MDL_WW,W(1,8))  !  count 3
      CALL FFV5_3(W(1,7),W(1,5),GC_49,MDL_MW,FK_MDL_WW,W(1,9))  !  count 2
      CALL FFV5P1N_1(W(1,3), W(1,8), GC_26, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/1,2/),
     & TMP, W, AMP(1,1))
      CALL FFV5_0(W(1,2),W(1,3),W(1,9),GC_26,AMP(4,1))
      CALL FFV5_0(W(1,2),W(1,4),W(1,8),GC_26,AMP(3,1))
      CALL FFV5_0(W(1,2),W(1,4),W(1,9),GC_26,AMP(2,1))  !  count 1
