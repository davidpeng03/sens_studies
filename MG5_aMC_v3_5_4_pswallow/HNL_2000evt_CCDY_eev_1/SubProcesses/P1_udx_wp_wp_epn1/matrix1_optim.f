...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      CALL IXXXXX(P(0,1),MDL_MU,-1,+1*IC(1),W(1,2))  !  count 4
      CALL OXXXXX(P(0,2),MDL_MD,+1,-1*IC(2),W(1,3))  !  count 4
      CALL OXXXXX(P(0,2),MDL_MD,-1,-1*IC(2),W(1,4))  !  count 1
      ...
      CALL FFV5_3(W(1,5),W(1,7),GC_49,MDL_MW,FK_MDL_WW,W(1,9))  !  count 1
      CALL FFV5_3(W(1,5),W(1,8),GC_49,MDL_MW,FK_MDL_WW,W(1,10))  !  count 3
      CALL FFV5_3(W(1,6),W(1,8),GC_49,MDL_MW,FK_MDL_WW,W(1,11))  !  count 1
      CALL FFV5_0(W(1,1),W(1,3),W(1,10),GC_179,AMP(1,1))
      CALL FFV5P1N_3(W(1,2), W(1,3), GC_179, TMP(1))
      call CombineAmp(3,
     & (/4,3,5/), 
     & (/9,10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV5_0(W(1,2),W(1,4),W(1,10),GC_179,AMP(2,1))  !  count 1
