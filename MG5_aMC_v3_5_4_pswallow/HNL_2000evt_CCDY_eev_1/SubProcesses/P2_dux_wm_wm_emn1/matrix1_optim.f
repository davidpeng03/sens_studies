...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      CALL IXXXXX(P(0,1),MDL_MD,-1,+1*IC(1),W(1,2))  !  count 4
      ...
      CALL FFV5_3(W(1,8),W(1,6),GC_49,MDL_MW,FK_MDL_WW,W(1,11))  !  count 2
      CALL FFV5P1N_3(W(1,1), W(1,3), GC_23, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV5P1N_3(W(1,2), W(1,3), GC_23, TMP(1))
      call CombineAmp(3,
     & (/6,5,4/), 
     & (/9,10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV5_0(W(1,2),W(1,4),W(1,10),GC_23,AMP(3,1))  !  count 1
