...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      CALL OXXXXX(P(0,2),MDL_MD,+1,-1*IC(2),W(1,3))  !  count 5
      CALL OXXXXX(P(0,2),MDL_MD,-1,-1*IC(2),W(1,4))  !  count 3
      CALL IXXXXX(P(0,3),MDL_ME,+1,-1*IC(3),W(1,5))  !  count 2
      CALL IXXXXX(P(0,3),MDL_ME,-1,-1*IC(3),W(1,6))  !  count 1
      CALL OXXXXX(P(0,4),MDL_MN1,+1,+1*IC(4),W(1,7))  !  count 1
      ...
      CALL FFV5_3(W(1,6),W(1,8),GC_49,MDL_MW,FK_MDL_WW,W(1,11))  !  count 1
      CALL FFV5P1N_3(W(1,1), W(1,3), GC_188, TMP(1))
      call CombineAmp(2,
     & (/3,2/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFV5_0(W(1,1),W(1,4),W(1,10),GC_188,AMP(1,1))
      CALL FFV5P1N_3(W(1,2), W(1,3), GC_188, TMP(1))
      call CombineAmp(3,
     & (/7,6,8/), 
     & (/9,10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV5P1N_3(W(1,2), W(1,4), GC_188, TMP(1))
      call CombineAmp(2,
     & (/5,4/), 
     & (/9,10/),
