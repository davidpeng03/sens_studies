...
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.5, 2024-06-17
...
C     
C     Process: s c~ > w- WEIGHTED<=2 @2
C     *   Decay: w- > e- n1 WEIGHTED<=2
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MS,+1,+1*IC(1),W(1,1))  !  count 3
      CALL IXXXXX(P(0,1),MDL_MS,-1,+1*IC(1),W(1,2))  !  count 6
      CALL OXXXXX(P(0,2),MDL_MC,+1,-1*IC(2),W(1,3))  !  count 6
      CALL OXXXXX(P(0,2),MDL_MC,-1,-1*IC(2),W(1,4))  !  count 3
      CALL OXXXXX(P(0,3),MDL_ME,+1,+1*IC(3),W(1,5))  !  count 2
      CALL OXXXXX(P(0,3),MDL_ME,-1,+1*IC(3),W(1,6))  !  count 2
      CALL IXXXXX(P(0,4),MDL_MN1,+1,-1*IC(4),W(1,7))  !  count 2
      CALL IXXXXX(P(0,4),MDL_MN1,-1,-1*IC(4),W(1,8))  !  count 2
      CALL FFV5_3(W(1,7),W(1,5),GC_49,MDL_MW,FK_MDL_WW,W(1,9))  !  count 1
      CALL FFV5_3(W(1,7),W(1,6),GC_49,MDL_MW,FK_MDL_WW,W(1,10))  !  count 4
      CALL FFV5_3(W(1,8),W(1,5),GC_49,MDL_MW,FK_MDL_WW,W(1,11))  !  count 1
      CALL FFV5_3(W(1,8),W(1,6),GC_49,MDL_MW,FK_MDL_WW,W(1,12))  !  count 3
      CALL FFV5P1N_3(W(1,1), W(1,3), GC_27, TMP(1))
      call CombineAmp(2,
     & (/3,2/), 
     & (/10,12/),
     & TMP, W, AMP(1,1))
      CALL FFV5_0(W(1,1),W(1,4),W(1,10),GC_27,AMP(1,1))
      CALL FFV5P1N_3(W(1,2), W(1,3), GC_27, TMP(1))
      call CombineAmp(4,
     & (/9,7,8,6/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,1))
      CALL FFV5P1N_3(W(1,2), W(1,4), GC_27, TMP(1))
      call CombineAmp(2,
     & (/5,4/), 
     & (/10,12/),
