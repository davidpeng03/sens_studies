...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MC,+1,+1*IC(1),W(1,1))  !  count 3
      CALL IXXXXX(P(0,1),MDL_MC,-1,+1*IC(1),W(1,2))  !  count 6
      CALL OXXXXX(P(0,2),MDL_MS,+1,-1*IC(2),W(1,3))  !  count 6
      CALL OXXXXX(P(0,2),MDL_MS,-1,-1*IC(2),W(1,4))  !  count 3
      CALL IXXXXX(P(0,3),MDL_ME,+1,-1*IC(3),W(1,5))  !  count 2
      CALL IXXXXX(P(0,3),MDL_ME,-1,-1*IC(3),W(1,6))  !  count 2
      CALL OXXXXX(P(0,4),MDL_MN1,+1,+1*IC(4),W(1,7))  !  count 2
      CALL OXXXXX(P(0,4),MDL_MN1,-1,+1*IC(4),W(1,8))  !  count 2
      CALL FFV5_3(W(1,5),W(1,7),GC_49,MDL_MW,FK_MDL_WW,W(1,9))  !  count 3
      CALL FFV5_3(W(1,5),W(1,8),GC_49,MDL_MW,FK_MDL_WW,W(1,10))  !  count 4
      CALL FFV5_3(W(1,6),W(1,7),GC_49,MDL_MW,FK_MDL_WW,W(1,11))  !  count 1
      CALL FFV5_3(W(1,6),W(1,8),GC_49,MDL_MW,FK_MDL_WW,W(1,12))  !  count 1
      CALL FFV5P1N_3(W(1,1), W(1,3), GC_191, TMP(1))
      call CombineAmp(2,
     & (/3,2/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFV5_0(W(1,1),W(1,4),W(1,10),GC_191,AMP(1,1))
      CALL FFV5P1N_3(W(1,2), W(1,3), GC_191, TMP(1))
      call CombineAmp(4,
     & (/7,6,9,8/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,1))
      CALL FFV5P1N_3(W(1,2), W(1,4), GC_191, TMP(1))
      call CombineAmp(2,
     & (/5,4/), 
     & (/9,10/),
