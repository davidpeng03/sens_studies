...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      CALL IXXXXX(P(0,1),MDL_MU,-1,+1*IC(1),W(1,2))  !  count 5
      CALL OXXXXX(P(0,2),MDL_MS,+1,-1*IC(2),W(1,3))  !  count 4
      ...
      CALL FFV5_3(W(1,5),W(1,7),GC_49,MDL_MW,FK_MDL_WW,W(1,9))  !  count 2
      ...
      CALL FFV5_0(W(1,1),W(1,3),W(1,10),GC_182,AMP(1,1))
      CALL FFV5P1N_3(W(1,2), W(1,3), GC_182, TMP(1))
      call CombineAmp(3,
     & (/5,4,6/), 
     & (/9,10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV5P1N_3(W(1,2), W(1,4), GC_182, TMP(1))
      call CombineAmp(2,
     & (/3,2/), 
     & (/9,10/),
