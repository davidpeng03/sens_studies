...
def createDFfromHEPMC(fileName):
    ...
    print(df)
    df.to_csv("/usera/dp728/run_dir/tempDF.csv")
...
if __name__=="__main__":
   ...
   #===========================================================================================================================================================
    ...
    print(start)
    parquetName = f"/usera/dp728/run_dir/tempDF_{runID}.parquet"
    ...
    #cutDict = sampleDFs
    createCTauFile(sampleDFs["LLPs"], runID, sampleInfoDicts, suffix="", outputDir="/usera/dp728/run_dir/")
