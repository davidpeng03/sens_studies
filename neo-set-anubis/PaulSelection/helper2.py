...
def performGeometryCut(LLPsSel, plot = True):
    print("2")
    import datetime
    import pickle
    import argparse
...
def checkDecayHits(LLPsGeo, nHits = 2, each=True):

    return LLPsGeo # return itself for now to be able to verify selection chain function
