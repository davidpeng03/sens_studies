...
def Version():
    return "1.0.0"
def authors():
    return "Paul Nathaniel Swallow, Théo Reymermier, Anna Jane Mullin, Sofie Nordahl Erner"
...
htmlhelp_basename = 'NeoSetAnubisman'
...
latex_documents = [ ('index', 'SetAnubisManual.tex', u'Set-Anubis Manual', authors(),
    "howto" ) ]
...
man_pages = [ ('index', 'setanubismanual', u'Set-Anubis Manual', [ authors() ], 1) ]
...
texinfo_documents = [
  ('index', 'SetAnubisManual', u'Set-Anubis Manual', authors(), 'SetAnubisManual', 
    'Set-Anubis -- a tool to make sensitivity prediction of Anubis Detector', 'Miscellaneous'),
]
