...
if __name__ == "__main__":
    ...
    for i in np.linspace(1,10,100):
        testbr.set_masses({"S" : i})

        decay_tot.append(testbr.calculate("DecayTot", "S"))
        decay_part.append(testbr.calculate("BR", "S", (12, -12,12)))
